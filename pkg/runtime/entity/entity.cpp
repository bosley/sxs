...
std::string entity_c::get_type_id() const {
  return "entity";
}
...
size_t entity_c::field_count() const {
  return 2;
}
...
std::string entity_c::get_id() const {
  return instance_id_;
}

bool entity_c::is_permitted(const std::string& scope, const char* permission) const {
...
void entity_c::grant_permission(const std::string& scope, const char* permission) {
...
void entity_c::set_permissions(const std::map<std::string, std::string>& perms) {
  permissions_ = perms;
  field_values_[0] = serialize_permissions();
}
...
bool entity_c::is_permitted_topic(std::uint16_t topic_id, const char* permission) const {
...
void entity_c::grant_topic_permission(std::uint16_t topic_id, const char* permission) {
