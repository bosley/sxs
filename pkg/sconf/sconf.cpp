...
sconf_builder_c::sconf_builder_c(const std::string& source)
    : source_(source) {}
...
sconf_builder_c& sconf_builder_c::WithField(sconf_type_e type, const std::string& name) {
    requirements_[name] = requirement_s{type, false};
    return *this;
}

sconf_builder_c& sconf_builder_c::WithList(sconf_type_e element_type, const std::string& name) {
    sconf_type_e list_type;
    switch (element_type) {
        case sconf_type_e::INT8: list_type = sconf_type_e::LIST_INT8; break;
        case sconf_type_e::INT16: list_type = sconf_type_e::LIST_INT16; break;
        case sconf_type_e::INT32: list_type = sconf_type_e::LIST_INT32; break;
        case sconf_type_e::INT64: list_type = sconf_type_e::LIST_INT64; break;
        case sconf_type_e::UINT8: list_type = sconf_type_e::LIST_UINT8; break;
        case sconf_type_e::UINT16: list_type = sconf_type_e::LIST_UINT16; break;
        case sconf_type_e::UINT32: list_type = sconf_type_e::LIST_UINT32; break;
        case sconf_type_e::UINT64: list_type = sconf_type_e::LIST_UINT64; break;
        case sconf_type_e::FLOAT32: list_type = sconf_type_e::LIST_FLOAT32; break;
        case sconf_type_e::FLOAT64: list_type = sconf_type_e::LIST_FLOAT64; break;
        case sconf_type_e::STRING: list_type = sconf_type_e::LIST_STRING; break;
        case sconf_type_e::LIST: list_type = sconf_type_e::LIST_LIST; break;
        default: list_type = element_type; break;
    }
    requirements_[name] = requirement_s{list_type, true};
    return *this;
}

static bool validate_type(const slp::slp_object_c& obj, sconf_type_e expected_type) {
...
static sconf_type_e get_element_type(sconf_type_e list_type) {
    switch (list_type) {
        case sconf_type_e::LIST_INT8: return sconf_type_e::INT8;
        case sconf_type_e::LIST_INT16: return sconf_type_e::INT16;
        case sconf_type_e::LIST_INT32: return sconf_type_e::INT32;
        case sconf_type_e::LIST_INT64: return sconf_type_e::INT64;
        case sconf_type_e::LIST_UINT8: return sconf_type_e::UINT8;
        case sconf_type_e::LIST_UINT16: return sconf_type_e::UINT16;
        case sconf_type_e::LIST_UINT32: return sconf_type_e::UINT32;
        case sconf_type_e::LIST_UINT64: return sconf_type_e::UINT64;
        case sconf_type_e::LIST_FLOAT32: return sconf_type_e::FLOAT32;
        case sconf_type_e::LIST_FLOAT64: return sconf_type_e::FLOAT64;
        case sconf_type_e::LIST_STRING: return sconf_type_e::STRING;
        case sconf_type_e::LIST_LIST: return sconf_type_e::LIST;
        default: return sconf_type_e::INT64;
    }
}

static bool validate_list(const slp::slp_object_c& obj, sconf_type_e expected_list_type, std::string& error_msg) {
    auto slp_type = obj.type();
    ...
    if (expected_list_type == sconf_type_e::LIST_LIST) {
        for (size_t i = 0; i < list.size(); ++i) {
            ...
            if (elem_type != slp::slp_type_e::PAREN_LIST &&
                ...
                error_msg = "List element at index " + std::to_string(i) + " is not a list";
                return false;
            }
        }
    } else {
